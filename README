...
Tell me exactly when I need to click macOS permission prompts, folder pickers, Windows installers, or account screens. Avoid paid subscriptions and avoid Microsoft account sign-in unless Windows blocks local setup.
```
